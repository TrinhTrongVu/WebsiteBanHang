    ...
    <div class="row">
        <div class="col-3 border mt-3 ">
            ...
            <c:forEach var="dsp" items="${dsp}">
                <a class="btn btn-outline-secondary m-1 w-50" href="/san-pham/${dsp.id}">${dsp.ten}</a><br>
            </c:forEach>
        </div>
        <div class="col-9  mt-3 p-2">
                <c:forEach var="sp" items="${pageData.content}">
                    <div class="card ms-5 mt-5 " style="width: 19rem;float: left;height: 470px" >
                        <a href="/san-pham/detail/${sp.id}">
                            <img src="/${sp.anh}" class="card-img-top mt-3"alt="ảnh">
                        </a>
                        <div class="card-body">
        ...
        <nav aria-label="Page navigation example" class="position-absolute mt-5">
            <ul class="pagination " style="margin-left: 55%">
                ...
                <c:forEach begin="0" end="${pageData.totalPages}" varStatus="page">
                    <li class="page-item"><a class="page-link" href="/san-pham?page=${page.index}">${page.index+1}</a></li>
                </c:forEach>
                <li class="page-item">
                </li>
            </ul>
